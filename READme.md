<div align="center">
  <img src="front-end/img/logo.png" alt="GabirIA Logo" width="200">
  <h1>GabirIA</h1>
...
*   **Obter explicações claras e concisas** sobre os tópicos mais importantes do ENEM.
...
1.  **Obtenha sua chave da API Gemini:**
    ...
    *   Crie um novo projeto e habilite a API Gemini.
    *   Gere uma chave de API para utilizar no projeto localmente.
...
3.  **Configure a API Key:**
    ...
    *   No arquivo `front-end/scripts/gemini-api.js`, substitua a string `'SUA_API_KEY'` pela chave da API Gemini que você obteve.

    ```javascript
    // filepath: front-end/scripts/gemini-api.js
